...
public class AccountsController {
  ...
  public ResponseEntity<Object> transferMoney(@RequestBody TransferMoneyRequest transferMoneyReq) {
    log.info("Transfering balance {}", transferMoneyReq);

    try {
        this.accountsService.transferMoney(transferMoneyReq);
       
    } catch ( AccountNotExistsException | InsufficientFundsException exception) {
